...
class UserManager(models.Manager):
	def reg_validator(self,postData):
		...
		if len(postData['first_name']) < 3:
			errors['first_name'] = "First Name must be at least 3 charecters."
		if len(postData['last_name']) < 3:
			errors['last_name'] = "Last Name must be at least 3 charecters."
	...
	def edit_validator(self,postData):
		...
		if len(postData['edit_first_name']) < 3:
			errors['edit_first_name'] = "First Name must be at least 3 charecters."
		if len(postData['edit_last_name']) < 3:
			errors['edit_last_name'] = "Last Name must be at least 3 charecters." 
		return errors
...
class QuoteManager(models.Manager):
	def quote_validator(self, postData):
		...
		if len(postData['author']) < 3:
			errors['author'] = "Author name Must be atleast 3 charecters"
		if len(postData['quote']) < 10:
			errors['quote'] = "Quotes must be at least 10 charecters"
		return errors
